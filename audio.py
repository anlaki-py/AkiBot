...
# ==============================================================================================================
    ...
    async def _convert_text_to_speech(self, text, voice_id, api_key):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(f"Text-to-speech error: {response.status_code} - {response.text}")
                return None
        except Exception as e:
        ...
        try:
            if update.message.photo:
                ...
                if audio_content:
                    ...
                    # If text-to-speech fails, just send the text response
                    await self.retry_operation(
                        update.message.reply_text,
                        result
                    )

# the keep alive functionality is not working and this now is a config editor for the bot.
        ...
        <div class="card">
            ...
            <div class="form-group">
                ...
                <select id="{{ category }}">
                    ...
                    <option value="BLOCK_LOW" {% if level == 'BLOCK_LOW' %}selected{% endif %}>BLOCK_LOW</option>
                    <option value="BLOCK_MEDIUM" {% if level == 'BLOCK_MEDIUM' %}selected{% endif %}>BLOCK_MEDIUM</option>
                    <option value="BLOCK_HIGH" {% if level == 'BLOCK_HIGH' %}selected{% endif %}>BLOCK_HIGH</option>
                </select>
            </div>
            {% endfor %}
